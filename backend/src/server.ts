...
prisma.$connect().then(() => {
  console.log('\x1b[36m✓ \x1b[32mPrismaORM\x1b[36m: connected & authenticated\x1b[0m');
}).catch((error) => {
  console.error('\x1b[36m✗ \x1b[31mPrismaORM\x1b[36m: Failed to connect to database\x1b[0m');
  console.error(error);
});
...
app.listen(PORT, () => {
  console.log('\x1b[36m✓ \x1b[32mVirtual-Classroom API\x1b[36m: Running on http://localhost:' + PORT + '\x1b[0m');
});
